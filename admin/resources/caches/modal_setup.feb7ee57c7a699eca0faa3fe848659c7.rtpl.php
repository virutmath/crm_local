...
<div id="wrapper-full">
    <div class="tabs-setup">
        <ul>
            <li id-tab="#setup" class="active">Cài đặt chung</li>
            <li id-tab="#setup-system">Cài đặt hệ thống</li>
            <li id-tab="#print">In ấn</li>
        </ul>
    </div>
    ...
    <form name="setup-form" method="post" action="index.php">
        ...
        <div class="left_content">
            ...
            <button type="button" onclick="config_submit()" class="btn btn-primary btn-xs">Lưu lại</button>
        </div>
    ...
    <form name="setup-system" method="post" action="">
        ...
        <div class="left_content">
            ...
            <button type="submit" class="btn btn-primary btn-xs">Lưu lại</button>
        </div>
        <div class="right_content">
            ...
            <div class="group_checkbox">
                <label>
                    ...
                    <input type="checkbox" name="notification" value="notice">
                </label>
            </div>
            <div class="clearfix"></div>
            <div class="box-notice">
                Cảnh báo thời gian công nợ trước thời hạn <input type="number" disabled="disabled" name="congno" style="width: 40px"> ngày
    ...
    <div class="content" id="print">
        <div class="left_content">qwerty</div>
